...
<body>
	...
	<main>
		...
		<div id="m2">
			<p id="hp">${sessionScope.userFN}'s Home Page</p>
			...
			<c:forEach var="post" items="${posts}">
				<div id="post">
				<div id="hm21">
					<form class="delete-form" method="POST" action="postdelete.do">
                    	<input type="hidden" name="id" value="${ post.id }" />
                    	<button id="x" type="submit">X</button>
                	</form>
					<p id="adam">${sessionScope.userFN} ${sessionScope.userLN}</p>
			...
			<div id="comment">
				<div id="cpost">
					<div id="chm21">
					<form class="delete-form" method="POST" action="hcommentdelete.do">
			...
			<form action="post.do" method="post">
				<c:forEach var="field" items="${form.visibleFields}">
					...
					<button id="npostsub">Submit</button>
				</c:forEach>
			</form>
			</div>
	</main>
